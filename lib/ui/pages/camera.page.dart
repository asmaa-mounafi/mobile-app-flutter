...
//     return Scaffold(
//         appBar: AppBar(title:Text('Camera'),backgroundColor: Colors.deepOrange,), body: Container(
//     child: Center(
//     child: Column( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
//     Container(
//     width: double.infinity, padding: EdgeInsets.all(10), child: MaterialButton(
//     color: Colors.blue, onPressed: (){ openDialog(context);},
...
//           onPressed: () async{
//             Navigator.of(context).pop();
//             var file=await ImagePicker.pickImage(source: ImageSource.camera,maxWidth: 400, maxHeight: 400); File croppedFile = await ImageCropper.cropImage(sourcePath: file.path); VisionText visionText=await textRecognoition(croppedFile);
